...
lastFormalParameter
:
	variableModifier* unannType annotation* ELIPSIS variableDeclaratorId
	| formalParameter
;
...
:
	...
	| typeName DOT SUPER DOT typeArguments? Identifier LPAREN argumentList?
	RPAREN
;
